...
public class GuiController {
    ...
    public GuiController(String locator){
    ...
    public static List<WebElement> getWebElementList(String locatorType,String locatorValue){
    ...
    public static void setWebDriver(BrowserType browserName){
        switch (browserName){
            case FIREFOX:
    ...
    private static String getDriverPath(BrowserType browserName){
        String osName=System.getProperty("os.name").toLowerCase();
        String driverpath=null;
        if(osName.contains("win")){
            driverpath=System.getProperty("user.dir")+"/src/main/resources/drivers/win/"+browserName.toString().toLowerCase()+"driver.exe";
        }
